 ...
 */
class TaxonomyManagerIndexForm extends FormBase {
	...
	public function buildForm( array $form, FormStateInterface $form_state ): array {
		...
		$this->results = $this->getResults( $form_state->getValue( 'suche' ),
	...
	public function getResults( $values, $vid ) {
		...
		/** @var  $query_all */
		$query_all = \Drupal::entityQuery( 'taxonomy_manager.form' );
		...
		/** @var $page */
		$page = pager_default_initialize( $this->results_total,
			$this->results_pro_page );
			...
			$my_array['operationen'] = [
				'data' => [
					...
					'#links' => [
						'edit'   => [
							...
							'url'   => Url::fromRoute(
								...
								[
									'query' =>
										[
											'destination' => '/admin/taxonomy-manager/form?vid=' . $vid,
										],
								]
							),
						],
						'delete' => [
							'title' => $this->t( 'Delete' ),
							'url'   => Url::fromUri( 'internal:/admin/taxonomy-manager/delete' . $vid . '/'
							                         . $term->id() ),
						],
					],
				],
	...
	public function getReferences() {
		...
		$query_references->condition( 'data',
			"%" . $query_references->escapeLike( 'entity_reference' ) . "%", 'LIKE' );
