 ...
 */
class TaxonomyManagerDeleteForm extends AbstractTaxonomyManagerForm {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state)
  {
      ...
      if(!is_numeric($form_state->getValue('tid'))){
          $form_state->setErrorByName('tid', $this->t('TID is expected to be an integer'));
      }

      if(empty(Term::load($form_state->getValue('tid')))){
          $form_state->setErrorByName('tid', $this->t('Term does not exist!'));
      }
  }
